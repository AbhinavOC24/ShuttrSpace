      ...
      items.map((p) =>
        prismaClient.photo.create({
          data: {
            ...
            location: p.location || "",
            cameraname: p.cameraDetails?.cameraname || "",
            lens: p.cameraDetails?.lens || "",
            aperture: p.cameraDetails?.aperture || "",
            iso: p.cameraDetails?.iso || "",
            shutterspeed: p.cameraDetails?.shutterspeed || "",
            metadataCid,
            signature,
          },
          select: {
